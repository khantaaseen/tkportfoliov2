export const profile = {
  ...
  email: "taaseenmkhan@gmail.com",
  phone: "+1 586-224-3124",
  ...
  intro: [
    ...
    "I graduated from Wayne State University with a BSc in Computer Science (3.8 GPA, Dean's List, Irvin D. Reid Honors College). My favorite problems sit where backend rigor meets product polish: payment infrastructure, scheduling systems, real-time integrations, and the occasional AI-powered feature.",
  ],
} as const;
